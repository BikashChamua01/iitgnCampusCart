    ...
    >
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        <div className="flex gap-2 mt-4">
          <button className="flex-1 cursor-pointer text-xs sm:text-sm font-semibold bg-[#a54ae7] text-white px-4 py-2 rounded-md hover:bg-white hover:text-[#7b4a8b] hover:border hover:border-[#b27dd8] transition duration-300">
            View Details
          </button>
          <button
            disabled={!available}
